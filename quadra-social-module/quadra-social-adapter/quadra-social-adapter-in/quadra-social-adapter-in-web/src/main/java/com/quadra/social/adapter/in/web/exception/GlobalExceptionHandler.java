package com.quadra.social.adapter.in.web.exception;
...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleDomainException(DomainException e) {
        ...
        if (e.getMessage() != null && e.getMessage().contains("已经关注")) {
            return Result.failure(ResultCode.ALREADY_FOLLOWED, e.getMessage());
        }
        if (e.getMessage() != null && e.getMessage().contains("未关注")) {
            return Result.failure(ResultCode.NOT_FOLLOWED, e.getMessage());
        }
